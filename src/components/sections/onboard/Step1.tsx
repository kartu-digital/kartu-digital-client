    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className=" space-y-16">
        <div className="grid justify-center xs:grid-cols-2 md:flex">
          <div
            onClick={() => setFormSelected({ category: 'undangan-digital' })}
          ...
          >
            <input
              ...
              checked={formSelected.category === 'undangan-digital'}
              onChange={handleRadioSelected}
            />
            <label className="cursor-pointer" htmlFor="undanganDigital">
              Undangan Digital
            </label>
          </div>
          <div
            onClick={() => setFormSelected({ category: 'kartu-digital' })}
          ...
          >
            <input
              ...
              onChange={handleRadioSelected}
            />
            <label className="cursor-pointer" htmlFor="kartuDigital">
              Kartu Digital
            </label>
          </div>
          <div
            onClick={() => setFormSelected({ category: 'link-in-bio' })}
          ...
          <div
            onClick={() => setFormSelected({ category: 'one-page' })}
