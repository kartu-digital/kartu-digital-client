                ...
                <div className="categoriesContainer mb-7 mt-24 flex flex-wrap justify-between gap-8 lg:mt-0">
                    <div className="mainCategory flex flex-wrap gap-6">
                        <Button
                            ...
                            onClick={() =>
                                handleButtonClick("Undangan Digital")
                            }
                        >
                        ...
                        {activeCat === "Kartu Digital" && (
                            <div className="subCats flex flex-wrap">
                                ...
                                <Button
                                    ...
                                    size={"sub_category"}
                                    onClick={() =>
                                        handleSecondClick("Personal Card")
                                    }
                                >
                                    Personal Card
                                </Button>
                                <Button
                                    ...
                                    size={"sub_category"}
                                    onClick={() =>
                                        handleSecondClick("Business Card")
                                    }
                                >
                                    Business Card
                                </Button>
                        ...
                        {activeCat === "Link in Bio" && (
                            <div className="subCats flex flex-wrap">
                                ...
                                <Button
                                    ...
                                    size={"sub_category"}
                                    onClick={() =>
                                        handleSecondClick("Social Media")
                                    }
                                >
                                    Social Media
                                </Button>
                                <Button
                                    ...
                                    size={"sub_category"}
                                    onClick={() =>
                                        handleSecondClick("Small Business")
                                    }
                                >
                                    Small Business
                                </Button>
