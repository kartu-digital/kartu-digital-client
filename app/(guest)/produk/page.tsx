...
const Page = () => {
    return (
        <div className="container mx-auto mt-20 lg:mt-0 mb-20">
            ...
            <div className="flex justify-center">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 px-2 md:px-0">
