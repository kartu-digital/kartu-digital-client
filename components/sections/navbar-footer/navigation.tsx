      ...
      >
        ...
        >
          ...
          <div className="mr-3 flex gap-4">
            <Link
              href={"/register"}
              className="border-2 border-neonGreen bg-neonGreen hover:bg-transparent hover:text-lime-400 transition-all duration-300 rounded-[34px] md:px-6 md:py-2 px-3 py-1 font-semibold text-sm md:text-lg flex items-center"
            >
              Get Started
            </Link>
            <button
              ...
              <div className="border-lightGray h-screen w-screen border-b-2">
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="produk" className="border-none">
                    ...
                    <AccordionContent className=" text-Black500 pl-3">
                      <Button
                        size={"mobile_nav"}
                        variant={"mobile_navigation"}
                        asChild
      ...
      <div className="relative hidden items-center lg:flex lg:gap-3">
        ...
        <NavigationMenu>
          <NavigationMenuItem className="list-none">
            ...
            <NavigationMenuContent>
              <ul className="grid w-[400px] gap-2 p-4 md:grid-cols-1 lg:w-[250px] bg-white">
                <li>
