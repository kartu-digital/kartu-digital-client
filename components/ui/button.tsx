    ...
    "rounded-md text-base font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                ...
                black: "flex items-center justify-center rounded-full border-2 border-black bg-black text-center text-white transition-all duration-300 hover:bg-transparent hover:text-black",
                purple_blue:
